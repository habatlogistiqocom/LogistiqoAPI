...
public class NotifiedGoods {
  ...
  **/
   ...
   * @return unit
  **/
  @Schema(example = "Europalette, Euro pallet, Stück, Colli, Box", description = "Enter the name of the packaging used for the for the notified goods item. If the unit does not exist in the Logistiqo system, it will be created.")
